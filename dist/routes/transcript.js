...
transcriptRouter.get('/transcript', async (c) => {
    ...
    try {
        ...
        if (!segments.length) {
            return c.json({ error: 'no_captions', message: 'No captions found for this video.' }, 404);
        }
        ...
        return c.json({ error: 'no_captions', message: 'No captions available for this video.' }, 404);
    }
});
